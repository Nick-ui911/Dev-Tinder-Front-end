  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900">
      <div className="my-10 mt-30 max-w-3xl mx-auto p-6 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950   text-white shadow-lg rounded-2xl">
        ...
        <p className="mb-4">
          At DevWorld, we strive to provide the best experience for our users.
          This policy outlines the conditions for cancellations and refunds.
        </p>

        <h2 className="text-2xl font-semibold mt-4">Cancellation Policy</h2>
        <p>
          Users may request a cancellation of services within 7 days of
          purchase. If the request is made within this period, the service will
          be discontinued, and a refund may be initiated based on our refund
          policy.
        </p>
        ...
        <ul className="list-disc ml-6">
          <li>
            Full refunds are available for cancellations within 7 days of
            purchase.
          </li>
        ...
        <p>
          Certain services may not be eligible for refunds due to their nature.
          These will be clearly mentioned at the time of purchase.
        </p>
        ...
        <p>
          ...
          contact us at nbaghel392@gmail.com.
        </p>
      </div>
    </div>
  );
